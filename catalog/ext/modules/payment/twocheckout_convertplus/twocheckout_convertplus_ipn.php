...
class twocheckout_convertplus_ipn {
	//Order Status Values:
	...
	private $order_status = MODULE_PAYMENT_2CHECKOUT_CONVERTPLUS_ORDER_STATUS_ID;
	private $secret_key = MODULE_PAYMENT_2CHECKOUT_CONVERTPLUS_SECRET_KEY;
	 ...
	 * @return bool
	 */
	protected function isNotFraud( $params ) {
	...
	public function processOrderStatus( $params ) {
		...
		if ( $existing_order['payment_method'] != '2Checkout Convert Plus' ) {
			return false;
		}
